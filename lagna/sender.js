...
function buildMessage(guest, templateName = "pranam") {
  ...
  const rsvpPdfNotice = [
    ...
    "━━━━━━━━━━━━━━━━━━━━",
    "महत्त्वाची सूचना:",
    "हा दुवा अंतिम निमंत्रण पत्रिका नाही.",
    "1. वेबसाइट दुव्यावर क्लिक करा.",
    "2. RSVP विभागात जा.",
    "3. आपल्या परिवाराची माहिती भरा.",
    "4. RSVP झाल्यानंतर आपली वैयक्तिक निमंत्रण पत्रिका तयार होईल.",
    "निमंत्रण पत्रिका स्थळी प्रवेशासाठी आवश्यक आहे. वेळ, कार्यक्रम आणि स्थळाची संपूर्ण माहिती निमंत्रण पत्रिकेत दिलेली आहे.",
    "",
    "IMPORTANT NOTE:",
    "This link is not the final invitation card.",
    "1. Click on the website link.",
    "2. Go to the RSVP section.",
    "3. Fill in your family details.",
    "4. Your personalized invitation card will be generated after RSVP.",
    "The invitation card is necessary for entry to the venue. Time, schedule, and venue details are included in the invitation card.",
    "━━━━━━━━━━━━━━━━━━━━"
  ].join("\n");
  ...
  const messages = {
    ready: [
      ...
      "कृपया आमंत्रण व्हिडिओ पुन्हा एकदा पाहा आणि नंतर खालील वैयक्तिक दुव्यावरून आपले निमंत्रण उघडा, संपूर्ण माहिती पहा व निमंत्रण पत्रिका डाउनलोड करा:",
      "",
      link,
      "",
      ...
      "Please watch the invitation video once more, then open your personal link above to view all details and download your invitation card.",
      englishFamilyNote,
      "",
